    ...
    <>
      ...
      <div className="flex row p-3 items-center mb-3">
        ...
        <input
          ...
          className="input input-bordered w-[400px] ml-2"
        ...
        <div className="dropdown">
          ...
          >
            <li
              className="font-bold p-2"
              onClick={() => setResultsLength(5)}
            >
              5
            </li>
            <li
              className="font-bold p-2"
              onClick={() => setResultsLength(10)}
            >
              10
            </li>
            <li
              className="font-bold p-2"
              onClick={() => setResultsLength(15)}
            >
              15
            </li>
          </ul>
